...
var $author$project$Api$AccessToken = F2(
	function (a, b) {
		return {$: 'AccessToken', a: a, b: b};
	});
...
var $author$project$Api$JWT = F2(
	function (exp, identity) {
		return {exp: exp, identity: identity};
	});
...
var $author$project$Api$jwtDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Api$JWT,
	A2($elm$json$Json$Decode$field, 'exp', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'identity', $author$project$User$decoder));
...
var $author$project$Api$decodeJWT = function (jwt) {
	var parts = A2($elm$core$String$split, '.', jwt);
	if (((parts.b && parts.b.b) && parts.b.b.b) && (!parts.b.b.b.b)) {
		...
		return A2(
			...
			$author$project$Api$jwtDecoder,
			A2(
				$elm$core$Result$withDefault,
				'',
				$truqu$elm_base64$Base64$decode(payload)));
	} else {
		var val = parts;
		return $elm$core$Result$Err(
			A2(
				...
				A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, val)));
	}
};
var $author$project$Api$toAccessToken = function (maybeToken) {
	var _v0 = $author$project$Api$decodeJWT(
		A2($elm$core$Maybe$withDefault, '', maybeToken));
	if (_v0.$ === 'Ok') {
		var json = _v0.a;
		return A2($author$project$Api$AccessToken, maybeToken, json.exp * 1000);
	} else {
		return A2($author$project$Api$AccessToken, maybeToken, 0);
	}
};
var $author$project$Api$RefreshToken = F2(
	function (a, b) {
		return {$: 'RefreshToken', a: a, b: b};
	});
var $author$project$Api$toRefreshToken = function (token) {
	var _v0 = $author$project$Api$decodeJWT(token);
	if (_v0.$ === 'Ok') {
		var json = _v0.a;
		return A2($author$project$Api$RefreshToken, token, json.exp);
	} else {
		return A2($author$project$Api$RefreshToken, token, 0);
	}
};
var $author$project$Api$credDecoder = A3(
	...
	A2(
		$elm$json$Json$Decode$map,
		$author$project$Api$toRefreshToken,
		A2($elm$json$Json$Decode$field, 'refresh', $elm$json$Json$Decode$string)),
	A2(
		$elm$json$Json$Decode$map,
		$author$project$Api$toAccessToken,
...
var $author$project$Api$decoderFromCred = function (decoder) {
	return A4(
		$elm$json$Json$Decode$map3,
		F3(
			function (fromCred, user, cred) {
				return A2(fromCred, user, cred);
			}),
		decoder,
...
var $author$project$Main$GotChatRoomMsg = function (a) {
	return {$: 'GotChatRoomMsg', a: a};
};
var $author$project$Main$Guest = function (a) {
	return {$: 'Guest', a: a};
};
...
var $author$project$Chat$Idle = function (a) {
	return {$: 'Idle', a: a};
};
var $author$project$Chat$fromList = function (chatList) {
	return $author$project$Chat$Idle(chatList);
};
var $author$project$ChatRoom$GotChats = function (a) {
	return {$: 'GotChats', a: a};
};
var $author$project$Chat$GroupChat = function (a) {
	return {$: 'GroupChat', a: a};
};
var $author$project$Chat$GroupChatRecord = F5(
	function (id, name, members, messages, pendingMsg) {
		return {id: id, members: members, messages: messages, name: name, pendingMsg: pendingMsg};
	});
var $author$project$Chat$PersonalChat = function (a) {
	return {$: 'PersonalChat', a: a};
};
var $author$project$Chat$PersonalChatRecord = F4(
	function (id, recipient, messages, pendingMsg) {
		return {id: id, messages: messages, pendingMsg: pendingMsg, recipient: recipient};
	});
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Chat$decoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$json$Json$Decode$map,
			...
			A6(
				$elm$json$Json$Decode$map5,
				$author$project$Chat$GroupChatRecord,
			...
			A5(
				...
				$author$project$Chat$PersonalChatRecord,
				A2($elm$json$Json$Decode$field, '_id', $elm$json$Json$Decode$string),
				A2($elm$json$Json$Decode$field, 'recipient', $author$project$User$decoder),
				$elm$json$Json$Decode$succeed(_List_Nil),
				$elm$json$Json$Decode$succeed('')))
		]));
var $author$project$Api$mainDecoder = function (subDecoder) {
	return A2($elm$json$Json$Decode$field, 'data', subDecoder);
};
var $author$project$Chat$chatsDecoder = $author$project$Api$mainDecoder(
	A2(
		$elm$json$Json$Decode$field,
		'chats',
		$elm$json$Json$Decode$list($author$project$Chat$decoder)));
...
var $author$project$ChatRoom$getChats = function (cred) {
	return $author$project$Api$get(
		{cred: cred, decoder: $author$project$Chat$chatsDecoder, endpoint: 'chats', toMsg: $author$project$ChatRoom$GotChats});
};
var $author$project$ChatRoom$init = function (viewer) {
	return _Utils_Tuple2(
		{
...
var $author$project$Api$viewerChanges = F2(
	function (toMsg, viewerDecoder) {
		return $author$project$Api$onStoreChange(
			function (value) {
				return toMsg(
					A2($author$project$Api$decodeFromChange, viewerDecoder, value));
			});
	});
...
var $author$project$Chat$moverToBody = F2(
	function (chats, sender) {
		if (chats.$ === 'Idle') {
			...
			var val2 = chats.b;
			var val3 = chats.c;
			var _v1 = A2($author$project$Chat$relocateMsg, val2, sender);
			var chat = _v1.a;
			var msg = _v1.b;
			return _Utils_Tuple2(
...
var $author$project$Chat$newLine = function (chats) {
	if (chats.$ === 'Idle') {
		return chats;
	} else {
		var val1 = chats.a;
		...
		return A3(
			...
			val1,
			A2(
				$author$project$Chat$changeText,
				val2,
...
var $author$project$Chat$split = F2(
	function (chatList, chat) {
		if (A2($elm$core$List$member, chat, chatList)) {
			var index = $elm$core$List$head(
				A2(
					$elm$core$List$map,
					...
					A2(
						...
						function (pair) {
							return _Utils_eq(pair.b, chat);
						},
						A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, chatList))));
			if (index.$ === 'Nothing') {
				return $elm$core$Maybe$Nothing;
			} else {
				var idx = index.a;
				var val2 = A2($elm$core$List$drop, idx + 1, chatList);
				var val1 = A2($elm$core$List$take, idx, chatList);
				return $elm$core$Maybe$Just(
					_Utils_Tuple3(val1, chat, val2));
			}
		} else {
			return $elm$core$Maybe$Nothing;
		}
	});
var $author$project$Chat$select = F2(
	function (chats, chat) {
		if (chats.$ === 'Idle') {
			var chatList = chats.a;
			var _v1 = A2($author$project$Chat$split, chatList, chat);
			if (_v1.$ === 'Nothing') {
				return $author$project$Chat$Idle(chatList);
			} else {
				var _v2 = _v1.a;
			...
			var _v3 = _Utils_Tuple2(
				A2($author$project$Chat$split, val1, chat),
				A2($author$project$Chat$split, val3, chat));
			_v3$2:
			while (true) {
				if (_v3.a.$ === 'Just') {
					if (_v3.b.$ === 'Nothing') {
				...
				_List_fromArray(
					[
						...
						$elm$json$Json$Encode$int(
							$elm$time$Time$posixToMillis(msg.timeStamp)))
					]));
		} else {
			var msg = message.a;
			return $elm$json$Json$Encode$object(
	...
	function (chats, text) {
		if (chats.$ === 'Idle') {
			...
			return A3(
				$author$project$Chat$Active,
				val1,
				A2($author$project$Chat$changeText, val2, text),
				val3);
		}
	});
var $author$project$Viewer$user = function (_v0) {
	var val = _v0.a;
	return val;
};
			...
			case 'NewLine':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							chats: $author$project$Chat$newLine(model.chats)
						}),
					$elm$core$Platform$Cmd$none);
			case 'SendMessage':
				var _v1 = A2(
					$author$project$Chat$moverToBody,
					model.chats,
...
var $author$project$Entrance$encode = function (model) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				_Utils_Tuple2(
				'remember_me',
				$elm$json$Json$Encode$bool(model.rememberMe))
			]));
};
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $author$project$Api$credToViewerDecoder = F2(
	function (toViewer, cred) {
		var _v0 = cred;
		var _v1 = _v0.b;
		var maybeToken = _v1.a;
		var jsonResult = $author$project$Api$decodeJWT(
			A2($elm$core$Maybe$withDefault, '', maybeToken));
		if (jsonResult.$ === 'Ok') {
			var json = jsonResult.a;
			return A2(
				$elm$json$Json$Decode$map,
				function (createViewer) {
					return $elm$core$Maybe$Just(
						A2(createViewer, json.identity, cred));
				},
				toViewer);
		} else {
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								...
								_Utils_Tuple2(
								'refresh',
								$elm$json$Json$Encode$string(rToken))
							])))
				]));
...
var $author$project$ChatRoom$NewLine = {$: 'NewLine'};
...
var $author$project$ChatRoom$onEnter = function (msg) {
	return A2(
...
var $author$project$ChatRoom$onShiftEnter = function (msg) {
	return A2(
		$elm$html$Html$Events$preventDefaultOn,
		'keydown',
		A2(
			...
			A2(
				...
				function (_v0) {
					var key = _v0.a;
					var shift = _v0.b;
					return ((key === 13) && shift) ? $elm$json$Json$Decode$succeed(msg) : $elm$json$Json$Decode$fail('Not shift + enter');
				},
				A3(
					$elm$json$Json$Decode$map2,
					F2(
						function (key, shift) {
							return _Utils_Tuple2(key, shift);
						}),
					$elm$html$Html$Events$keyCode,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$ChatRoom$onEnter($author$project$ChatRoom$SendMessage))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$htmlAttribute(
						$author$project$ChatRoom$onShiftEnter($author$project$ChatRoom$NewLine)),
						$mdgriffith$elm_ui$Element$Font$size(16)
					]),
				{
					label: $mdgriffith$elm_ui$Element$Input$labelHidden('msg'),
					onChange: $author$project$ChatRoom$ChangText,
					placeholder: $elm$core$Maybe$Just(
						A2(
							$mdgriffith$elm_ui$Element$Input$placeholder,
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('Type a message'))),
					spellcheck: true,
					text: msg
				})
			]));
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(
							open ? A4($mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.2) : A4($mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.1))
						])),
					$mdgriffith$elm_ui$Element$Background$color(
					open ? A4($mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.2) : A4($mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0))
				]),
			_List_fromArray(
				[
			...
			_List_Nil,
			{
				...
				icon: function (_v0) {
					return A2(
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
						show ? {description: 'vOn', src: '/assets/visibility-24px.svg'} : {description: 'vOff', src: '/assets/visibility_off-24px.svg'});
				},
				label: $mdgriffith$elm_ui$Element$Input$labelHidden('show password'),
				onChange: $author$project$Entrance$ToggleShowPassword
			}));
};
var $author$project$Entrance$viewPasswordField = F2(
...
var $author$project$Entrance$viewForm = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[$mdgriffith$elm_ui$Element$centerY, $mdgriffith$elm_ui$Element$centerX]),
		$author$project$Entrance$popOutEffect(
			A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
...
var $author$project$Entrance$view = function (model) {
	return {
		content: $author$project$Entrance$viewForm(model),
		title: 'Entrance'
	};
};
var $author$project$Main$view = function (model) {
			...
			return {
				body: _List_fromArray(
					[
						...
						A2($mdgriffith$elm_ui$Element$map, toMsg, content))
					]),
	...
	if (model.$ === 'Guest') {
		...
		return A2(
			...
			$author$project$Main$GotChatRoomMsg);
	}
};
